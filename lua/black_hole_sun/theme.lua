...
theme.set_highlights = function()
  ...
  hl(0, "LineNr", { fg = c.line_no, bg = 'NONE' })
  ...
  hl(0, "Directory", { fg = c.white, bg = 'NONE' })
  hl(0, "SpecialKey", { fg = c.cyan, bg = 'NONE', bold=true, })
  hl(0, "Title", { fg = c.neontitle, bg = 'NONE', bold=true, })
  ...
  hl(0, "Identifier", { fg = c.neontitle, bg = 'NONE' })
  ...
  -- StatusLine
  hl(0, "StatusLine", { fg = c.line, bg = c.line_no })
